...
int main() {
    ...
    Shader ourShader("vertexShaderSource.vs", "fragmentShaderSource.fs");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        for (unsigned int i = 1; i <= 10; i++) {
            ...
            if (i % 3 == 1) {
                rotationAngle *= (float)glfwGetTime() * glm::radians(angle);
            }
            else {
...
void mouse_callback(GLFWwindow* window, double xposIn, double yposIn) {
    ...
    // the origin in glfw window is at top left corner of the screen, ypos goes down when mouse moves up
